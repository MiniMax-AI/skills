...
| `podcast-creator` | Convert text scripts into podcast episodes with narration and music. Supports plain text, Markdown, or structured JSON input. Generates narration via MiniMax TTS API and intro/outro music via MiniMax Music API, then assembles with ffmpeg. | Official |
