...
| `minimax-chart` | Generate publication-ready data visualizations from CSV, JSON, or inline data. Auto-detects chart type (bar, line, scatter, pie, heatmap, histogram). Four style presets (modern, vibrant, academic, dark). Outputs PNG, SVG, or PDF. | Official |
