...
| `social-media-kit` | Generate branded image packs for social media platforms. Supports Instagram (Post, Story), X/Twitter, YouTube thumbnails, and LinkedIn. Batch generation with platform-specific aspect ratios via MiniMax Image API. | Official |
