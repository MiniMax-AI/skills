...
```bash
uv run python SKILL_DIR/scripts/xlsx_reader.py input.xlsx                 # full report
uv run python SKILL_DIR/scripts/xlsx_reader.py input.xlsx --sheet Sales   # single sheet
uv run python SKILL_DIR/scripts/xlsx_reader.py input.xlsx --quality       # quality audit only
uv run python SKILL_DIR/scripts/xlsx_reader.py input.xlsx --json          # machine-readable
```
